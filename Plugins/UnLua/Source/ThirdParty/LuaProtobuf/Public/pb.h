...
int luaopen_pb_slice(struct lua_State *L);
int luaopen_pb_buffer(struct lua_State *L);
int luaopen_pb_conv(struct lua_State *L);
int luaopen_pb_io(struct lua_State *L);
